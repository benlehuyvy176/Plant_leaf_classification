...
def segment_leaf(original_image, filling_mode, smooth_boundary, marker_intensity):
    """
    ...
    original, marker = generate_background_marker(original_image)
    ...
    if marker_intensity > 0:
        ...
        image = original.copy()
        image[largest_mask == 0] = np.array([255, 255, 255])
